...
module "cloud-scheduler" {
  ...
  bigquery_classify_url = module.cloud-functions.bigquery_classify_function_uri
...
module "cloud-functions" {
  ...
  bigquery_classify_bucket = module.cloud-storage.function_bucket_bigquery_classify
  bigquery_classify_object = module.cloud-storage.function_object_bigquery_classify
  bigquery_classify_data   = module.cloud-storage.function_data_bigquery_classify
